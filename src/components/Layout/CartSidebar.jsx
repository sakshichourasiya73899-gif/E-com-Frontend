...
if(!isCartOpen) return null;
  ...
  <div className="fixed right-0 top-0 h-full w-96 z-50 glass-panel animate-slie-in-right overflow-y-auto">
    <div className="flex items-center justify-between p-6 border-b border-[hsla(var(--glass-border))]">
      ...
      <h2 className="text-xl font-semibold text-primary">Shoppin Cart</h2>
     <button onClick={
          ()=>{
             
            dispatch(toggleCart())}} className="p-2 rounded-lg glass-card hover:glow-on-hover animate-smooth">
      ...
      <div className="p-6">
        {
          ...
          {/* CART ITEMs */}
                    ...
                    <div key={item.product.id} className="glass-card-p-4">
                      <div className="flex items-center space-x-4 ">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-primary font-semibold">${item.product.id}</p>
                        </div>
                        {/* Quantity Controls */}
            ...
            <div className="border-t border-[hsla(var(--glass-border))] pt-4">
              ...
              <Link to={"/cart"} onClick={()=>dispatch(toggleCart())} className="w-full block text-center gradient-primary text-primary-foreground hover:glow-on-hover animate-smooth font-semibold">View cart and checkout</Link>
